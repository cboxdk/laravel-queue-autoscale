...
- [Workload Profiles](workload-profiles.md) — the six shipped profiles + when to pick each
...
- [Failure Fuse](failure-fuse.md) — the circuit breaker that stops the autoscaler scaling into a downstream outage
...
- [Scaling Policies](scaling-policies.md) — the shipped policies and how to write your own
