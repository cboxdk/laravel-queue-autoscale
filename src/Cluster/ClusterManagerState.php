...
final readonly class ClusterManagerState
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'cpu_usable_cores' => $this->cpuUsableCores,
            'cpu_reserved_cores' => $this->cpuReservedCores,
    ...
    public static function fromArray(array $payload): self
    {
        ...
        return new self(
            ...
            cpuCores: is_numeric($payload['cpu_cores'] ?? null) ? (int) $payload['cpu_cores'] : 0,
            cpuUsableCores: is_numeric($payload['cpu_usable_cores'] ?? null) ? (int) $payload['cpu_usable_cores'] : 0,
